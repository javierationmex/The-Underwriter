...
(defrule over-18
 ...
 (printout t "           o--------------------------------------o" crlf)
 (printout t crlf)
 (printout t "        You will be given a percentage at the end of this " crlf)
 (printout t "          program that represents how probable it is for  " crlf)
 (printout t "          you to get your desired mortgage. As long as   " crlf)
 (printout t "          the percentage is greater than 50 you have a  " crlf)
 (printout t "          great chance!!  " crlf)
 (printout t crlf)
